...
class SPFastRCNNOutputs:
    ...
    def softmax_cross_entropy_loss(self):
        ...
        if self._no_instances:
            ...
            self._log_accuracy()
            return F.cross_entropy(self.pred_class_logits, self.gt_classes, weight=self.weight, reduction="mean")
...
class SPFastRCNNOutputLayers(nn.Module):
    """
